...
// ---- Trust / social proof ----
export const GOOGLE_RATING = { score: "5.0", count: 26 };
    ...
    ranges: [
      {
        ...
        prices: [
          { kw: "2.5kW", model: "FTKM25WVMA", price: "$1,690" },
          { kw: "3.5kW", model: "FTKM35WVMA", price: "$1,890" },
          { kw: "5.0kW", model: "FTKM50WVMA", price: "$2,490" },
          { kw: "7.1kW", model: "FTKM71WVMA", price: "$2,790" },
        ],
      },
      {
        slug: "alira-x",
        ...
        prices: [
          { kw: "2.5kW", price: "$1,990" },
          { kw: "3.5kW", price: "$2,290" },
          { kw: "5.0kW", price: "$2,890" },
          { kw: "7.1kW", price: "$3,390" },
        ],
      },
      {
        slug: "zena",
        ...
        prices: [
          { kw: "2.5kW", model: "FTXJ25TVMAW / K", price: "$2,190" },
          { kw: "3.5kW", model: "FTXJ35TVMAW / K", price: "$2,490" },
          { kw: "5.0kW", model: "FTXJ50TVMAW / K", price: "$3,090" },
          { kw: "6.0kW", model: "FTXJ60TVMAW / K", price: "$3,390" },
        ],
      },
    ],
  },
    ...
    ranges: [
      {
        ...
        prices: [
          { kw: "2.5kW", price: "$1,890" },
          { kw: "3.5kW", price: "$2,090" },
          { kw: "5.0kW", price: "$2,690" },
          { kw: "7.1kW", price: "$3,190" },
        ],
      },
      {
        slug: "heavy-ciara",
        ...
        prices: [
          { kw: "2.0kW", price: "$1,790" },
          { kw: "2.5kW", price: "$1,890" },
          { kw: "3.3kW", price: "$2,090" },
          { kw: "5.0kW", price: "$2,690" },
          { kw: "6.3kW", price: "$2,890" },
          { kw: "7.1kW", price: "$2,990" },
        ],
      },
    ],
  },
    ...
    ranges: [
      {
        ...
        prices: [
          { kw: "2.5kW", model: "ASTG09KMTC", price: "$1,890" },
          { kw: "3.5kW", model: "ASTG12KMTC", price: "$2,090" },
          { kw: "5.0kW", model: "ASTG18KMTC", price: "$2,690" },
          { kw: "6.0kW", model: "ASTG22KMTC", price: "$2,890" },
          { kw: "7.1kW", model: "ASTG24KMTC", price: "$2,990" },
        ],
      },
    ],
  },
    ...
    ranges: [
      {
        ...
        prices: [
          { kw: "2.5kW", model: "AR09DXEANWKNSA", price: "$1,890" },
          { kw: "3.5kW", model: "AR12DXEANWKNSA", price: "$2,090" },
          { kw: "5.0kW", model: "AR18DXEANWKNSA", price: "$2,690" },
          { kw: "7.0kW", model: "AR24DXEANWKNSA", price: "$2,990" },
          { kw: "8.0kW", model: "AR30DXEANWKNSA", price: "$3,290" },
        ],
      },
    ],
  },
