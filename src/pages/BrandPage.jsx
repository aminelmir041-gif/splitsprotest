        ...
        <section className="border-y border-[#E8E6E1] bg-[#FBFAF8] py-14 sm:py-18" data-testid="back-to-back-explained">
          <div className="sp-container grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-start lg:gap-14">
            <div>
              ...
              <p className="mt-5 text-xs leading-relaxed text-[#6E6E73]">Standard electrical work is included for a qualifying ground-floor installation with less than 10 metres of electrical run. Switchboard defects, upgrades, asbestos-related work or other site conditions outside the standard installation are discussed and approved before any extra work proceeds.</p>
            </div>
