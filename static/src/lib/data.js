import { Snowflake, Wind, Wrench, Sparkles, ShieldCheck, HeartHandshake, BadgeCheck, Home as HomeIcon, Brush, MessageSquareQuote, } from "lucide-react";
...
export const TRUST_QUOTE = "Professional, punctual and meticulous. Splits Pro genuinely care about getting the installation right the first time.";
...
export const PRICING_DISCLAIMER = "Prices shown are based on a standard back-to-back installation. Additional pipework, electrical work, brackets, difficult access or other non-standard installation requirements may incur additional costs. Any additional costs will be confirmed before work proceeds.";
