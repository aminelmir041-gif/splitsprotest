...
import HomeComfortPage from "./HomeComfortPage.js";
import { IMAGES } from "../lib/data.js";
const Ducted = () => (_jsx(HomeComfortPage, { slug: "ducted", overline: "Ducted Air Conditioning", title: "Whole-home comfort, elegantly hidden", sub: "Zoned ducted air conditioning concealed within your ceiling \u2014 seamless comfort with discreet vents and intelligent control.", image: IMAGES.controller, introImage: IMAGES.controller, imgPos: "object-center", intro: {
